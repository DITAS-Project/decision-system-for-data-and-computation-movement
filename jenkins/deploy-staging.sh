...
sudo docker run -p 30003:8080 --restart unless-stopped -d --name decision-system-for-data-and-computation-movement ditas/decision-system-for-data-and-computation-movement:latest
ENDSSH
